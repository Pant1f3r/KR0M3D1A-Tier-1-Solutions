...
import { GeneticForensics } from './components/GeneticForensics';
import { VocalForensics } from './components/VocalForensics';
import { BiometricStatusDashboard } from './components/BiometricStatusDashboard';
            ...
            <SectorGuard sectorName={String(currentView)}>
                {(() => {
                    switch (currentView) {
                        ...
                        case 'dna-sequencing': return <GeneticForensics />;
                        case 'vocal-forensics': return <VocalForensics />;
                        case 'biometric-status': return <BiometricStatusDashboard />;
                        ...
                        case 'ai-gen': return <ImageGeneration onSubmit={() => {}} isLoading={false} generatedImage={null} error="" isUpscaling={false} upscaledImage={null} onUpscale={() => {}} />;
